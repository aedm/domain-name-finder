...
async fn write_output(mut rx: Receiver<String>, original_file_name: String) -> Result<()> {
...
async fn main() -> Result<()> {
    ...
    let writer_task =
        tokio::spawn(async { write_output(filter_to_output_recv, original_file_name).await });
